                    ...
                    for (let user of participants) {
                       let pp = 'https://telegra.ph/file/ddd756ee15579bdfba651.jpg'
                        try {
                            ...
                            text = (action === 'add' ? (chat.sWelcome || this.welcome || conn.welcome || 'Intro Dulu Yuk Biar Keren🤙                  📛 Nama :                                                                 🔞 Umur :                                                                 🏙️ Askot :                                                            Semoga Kamu Senang Berada Disini Serta Jangan Lupa Untuk Membaca Dan Mematuhi Rules Yang Ada').replace('@subject', groupMetadata.subject).replace('@desc', groupMetadata.desc.toString()) :
                                (chat.sBye || this.bye || conn.bye || 'Tetap Putus Asa Jangan Semangat Dan Jadilah Beban Keluarga 🤙🗿`)).replace('@user', '@' + user.split('@')[0])
...
⬡ Kamu Belum Terdaftar Di Dalam Database Bot
